...
| 5. Trusted Operator Controls      | not started | Phase 4 complete | Trusted project config, trust-safe prompts, live commands, and manual compression are available        | [Phase 5](2026-07-28-pi-dcp-phase-5-operator-and-release-hardening.md) |
