...
| --------------------------------- | ----------- | ---------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| 1. Pruning Foundation             | not started | v0.4.1 baseline  | Failed inputs are purged without losing diagnostics; lookup outputs can deduplicate                    | [Phase 1](2026-07-28-pi-dcp-phase-1-pruning-foundation.md)             |
